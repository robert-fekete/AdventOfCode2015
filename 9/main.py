...
def parse(content):
    ...
    for line in content.split("\n"):
        ...
        from_city, to_city = cities.strip().split("to")

        distances.append((from_city.strip(), to_city.strip(), int(distance.strip())))
...
def alg1():
    ...
    cities.remove("NorthPole")
    calc_distance(cities, ["NorthPole"])
